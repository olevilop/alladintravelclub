        ...
        {allTours.map((tour) => (
          ...
          >
            <div className="flex flex-col md:flex-row">
              ...
              {/* Price / Duration */}
              <div className="md:w-[240px] flex-shrink-0 p-6 md:p-8 flex flex-col justify-center space-y-3 <div className="md:w-[240px] flex-shrink-0 p-6 md:p-8 flex flex-col justify-center space-y-3 md:border-l md:border-border/30">">
