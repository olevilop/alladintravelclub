      ...
      <div ref={ref} className="container mx-auto px-6">
        ...
        >
          ...
          <p className="mt-6 text-muted-foreground font-sans leading-relaxed">
            Terra Elite — это клуб путешественников, объединённых страстью к исследованию
            самых труднодоступных и уникальных мест на планете. Мы работаем с ведущими
            мировыми операторами экспедиционных круизов и создаём маршруты, которые
