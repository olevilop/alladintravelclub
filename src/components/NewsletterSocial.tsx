...
const NewsletterSocial = () => {
  ...
  return (
    <section className="container mx-auto px-6 py-12">
      <div className="grid grid-cols-1 <div className="grid grid-cols-1 md:grid-cols-[1fr_240px] gap-4"> gap-4">
        {/* Newsletter */}
          ...
          <h3 className="font-serif text-xl md:text-2xl font-light">
           ...
           <div className="flex flex-col gap-1.5 mt-auto items-start">
            <a
              ...
              className="inline-flex items-center justify-center gap-1.5 px-3 py-1.5 rounded-sm text-[10px] font-sans uppercase tracking-wider transition-colors w-1/2"
