            ...
            {footerLinks.map((col) => (
              <div key={col.title}>
                ...
                <ul className="space-y-2">
                  {col.links.map((link) => (
                    <li key={link}>
              {link === "Политика конфиденциальности" || link === "Событийный туризм" || link === "Спецпредложения" || link === "Экскурсионные туры" || link === "Активные туры" || link === "Авторские туры" || link === "Корпоративные туры" || link === "Оздоровительные" || link === "Сафари" || link === "Дайвинг" || link === "О нас" || link === "Наша команда" ? (
                        <Link
                          to={
                            link === "Политика конфиденциальности"
                              ...
                              : link === "Авторские туры"
                              ? "/author-tours"
                              : link === "Корпоративные туры"
                              ? "/corporate-tours"
                              : link === "Оздоровительные"
                              ? "/wellness-tours"
                              : link === "Сафари"
                              ? "/safari-tours"
                              : link === "Дайвинг"
