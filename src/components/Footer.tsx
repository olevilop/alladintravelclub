            ...
            {footerLinks.map((col) => (
              <div key={col.title}>
                ...
                <ul className="space-y-2">
                  {col.links.map((link) => (
                    <li key={link}>
                      {link === "Политика конфиденциальности" || link === "Событийный туризм" || link === "Спецпредложения" || link === "Экскурсионные туры" || link === "Активные туры" || link === "Авторские туры" || link === "Корпоративные туры" || link === "Оздоровительные" ? (
                        <Link
                          to={
